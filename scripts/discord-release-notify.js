...
async function postToDiscord(webhookUrl, version, notes) {
  ...
  const repoUrl = 'https://github.com/YD-233/kimi-mem';

  const payload = {
    embeds: [
      {
        title: `🚀 kimi-mem ${version} released`,
        ...
        fields: [
          ...
          {
            name: '📚 Docs',
            value: '[docs.kimi-mem.ai](https://docs.kimi-mem.ai)',
            inline: true,
          },
        ],
        footer: {
          text: 'kimi-mem • Persistent memory for Claude Code',
        },
