...
function printHelp(): void {
  console.log(`
bug-report - Generate bug reports for kimi-mem
...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for kimi-mem using the Claude Agent SDK.
...
async function main() {
  ...
  console.log(`   Kimi-Mem: v${diagnostics.versions.kimiMem}`);
  ...
  const githubUrl = `https://github.com/YD-233/kimi-mem/issues/new?title=${encodedTitle}&body=${encodedBody}`;
