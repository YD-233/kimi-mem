# Feature Parity: Kimi-Mem Hooks vs Cursor Hooks

This document compares kimi-mem's Claude Code hooks with the Cursor hooks implementation to ensure feature parity.
...
**How it works**:
- Hook writes context to `.cursor/rules/kimi-mem-context.mdc`
...
### Tag Stripping
- **Claude Code**: Worker handles `<private>` and `<kimi-mem-context>` tags
...
**Overall**: The Cursor hooks implementation achieves **full functional parity** with kimi-mem's Claude Code hooks:
