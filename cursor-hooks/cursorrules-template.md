...
If you want to add custom instructions about kimi-mem (beyond the auto-injected context), create a separate rules file:

### `.cursor/rules/kimi-mem-instructions.mdc`

```markdown
---
alwaysApply: true
description: "Instructions for using kimi-mem memory system"
---

# Memory System Usage

You have access to kimi-mem, a persistent memory system. In addition to the auto-injected context above, you can search for more detailed information using MCP tools:
...
|------|---------|------------|
| `.cursor/rules/kimi-mem-context.mdc` | Auto-injected context | Hook (automatic) |
| `.cursor/rules/kimi-mem-instructions.mdc` | MCP tool instructions | You (optional) |
