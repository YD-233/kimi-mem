# Quick Start: Kimi-Mem + Cursor Integration

> **Give your Cursor AI persistent memory in under 5 minutes**

## What This Does

Connects kimi-mem to Cursor so that:
...
kimi-mem settings set KIMI_MEM_PROVIDER gemini
kimi-mem settings set KIMI_MEM_GEMINI_API_KEY your-api-key

# Option B: OpenRouter (free models available)
kimi-mem settings set KIMI_MEM_PROVIDER openrouter
kimi-mem settings set KIMI_MEM_OPENROUTER_API_KEY your-api-key
```
...
- kimi-mem provides search tools via MCP
...
- Check logs: `tail -f ~/.kimi-mem/logs/worker-$(date +%Y-%m-%d).log`
...
- Visit [kimi-mem docs](https://docs.kimi-mem.ai) for full feature set
