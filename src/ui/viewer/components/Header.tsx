  ...
  return (
    <div className="header">
      <div className="header-main">
        <h1>
          <div style={{ position: 'relative', display: 'inline-block' }}>
            <img src="kimi-mem-logomark.webp" alt="" className={`logomark ${isProcessing ? 'spinning' : ''}`} />
            {queueDepth > 0 && (
          ...
          <span className="logo-text">kimi-mem</span>
        </h1>
      </div>
      <div className="status">
        ...
        <GitHubStarsButton username="YD-233" repo="kimi-mem" />
        <select
          value={currentFilter}
