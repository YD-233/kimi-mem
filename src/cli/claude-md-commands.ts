...
function formatObservationsForClaudeMd(observations: ObservationRow[], folderPath: string): string {
  ...
  lines.push('');
  lines.push('<!-- This section is auto-generated by kimi-mem. Edit content outside the tags. -->');
  lines.push('');
...
export async function generateClaudeMd(dryRun: boolean): Promise<number> {
  ...
  const observationLimit = parseInt(settings.KIMI_MEM_CONTEXT_OBSERVATIONS, 10) || 50;
