...
"use strict";var $=Object.defineProperty;var Te=Object.getOwnPropertyDescriptor;var be=Object.getOwnPropertyNames;var fe=Object.prototype.hasOwnProperty;var ge=(i,e)=>{for(var t in e)$(i,t,{get:e[t],enumerable:!0})},Se=(i,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of be(e))!fe.call(i,n)&&n!==t&&$(i,n,{get:()=>e[n],enumerable:!(s=Te(e,n))||s.enumerable});return i};var Ne=i=>Se($({},"__esModule",{value:!0}),i);var Ge={};ge(Ge,{SessionStore:()=>z});module.exports=Ne(Ge);var Q=require("bun:sqlite"),Ee=require("crypto");var b=require("path"),M=require("os"),U=require("fs"),ee=require("url");var he=null;function Re(i){return(he??process.stderr.write.bind(process.stderr))(i)}function k(i){Re(i)}var We=process.platform==="win32";function Ie(i){return i.replace(/^\uFEFF/,"")}function X(i){return JSON.parse(Ie(i))}function Oe(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,ee.fileURLToPath)(__IMPORT_META_URL__))}var Ke=Oe();function Z(i){return typeof i!="string"||i.length===0?i:i==="~"?(0,M.homedir)():i.startsWith("~/")?(0,b.join)((0,M.homedir)(),i.slice(2)):i}function Ae(){if(process.env.KIMI_MEM_DATA_DIR)return Z(process.env.KIMI_MEM_DATA_DIR);let i=(0,b.join)((0,M.homedir)(),".kimi-mem"),e=(0,b.join)(i,"settings.json");try{if((0,U.existsSync)(e)){let t=X((0,U.readFileSync)(e,"utf-8")),s=t.env??t;if(s.KIMI_MEM_DATA_DIR)return Z(s.KIMI_MEM_DATA_DIR)}}catch{}return i}var I=Ae(),Le=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,M.homedir)(),".claude"),Je=(0,b.join)(Le,"plugins","marketplaces","YD-233"),ye=(0,b.join)(I,"logs"),Qe=(0,b.join)(I,"settings.json"),se=(0,b.join)(I,"kimi-mem.db"),ve=(0,b.join)(I,"observer-sessions"),j=(0,b.basename)(ve);function te(i){(0,U.mkdirSync)(i,{recursive:!0})}var H={dataDir:()=>I,workerPid:()=>(0,b.join)(I,"worker.pid"),serverPid:()=>(0,b.join)(I,".server-beta.pid"),serverPort:()=>(0,b.join)(I,".server-beta.port"),serverRuntime:()=>(0,b.join)(I,".server-beta.runtime.json"),settings:()=>(0,b.join)(I,"settings.json"),database:()=>(0,b.join)(I,"kimi-mem.db"),chroma:()=>(0,b.join)(I,"chroma"),combinedCerts:()=>(0,b.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,b.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,b.join)(I,"transcript-watch-state.json"),corpora:()=>(0,b.join)(I,"corpora"),supervisorRegistry:()=>(0,b.join)(I,"supervisor.json"),envFile:()=>(0,b.join)(I,".env"),logsDir:()=>ye};var v=require("fs"),ne=require("path");var q=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(q||{}),W=null,V=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=H.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,ne.join)(e,`kimi-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=H.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(X(t).KIMI_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=q[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
