...
description: Build and query AI-powered knowledge bases from kimi-mem observations. Use when users want to create focused "brains" from their observation history, ask questions about past work patterns, or compile expertise on specific topics.
---

# Knowledge Agent

Build and query AI-powered knowledge bases from kimi-mem observations.
...
```text
build_corpus name="hooks-expertise" description="Everything about the hooks lifecycle" project="kimi-mem" concepts="hooks" limit=500
```
