...
### Custom Grammars (`.kimi-mem.json`)

You can register additional tree-sitter grammars for file types not in the bundled list. Create or update `.kimi-mem.json` in your project root:
