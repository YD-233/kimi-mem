...
// turns to a single shared markdown file (default ~/.kimi-mem/STANDUP.md).
...
//   --file <path>   | STANDUP_FILE  | ~/.kimi-mem/STANDUP.md
...
function defaultFile() {
  return (
    ...
    join(homedir(), ".kimi-mem", "STANDUP.md")
  );
}
...
file defaults to ~/.kimi-mem/STANDUP.md; override with --file or STANDUP_FILE.`;
