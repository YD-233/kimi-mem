...
<p align="center">
  Kimi-Mem preserva o contexto perfeitamente entre sessões, capturando automaticamente observações de uso de ferramentas, gerando resumos semânticos e disponibilizando-os para sessões futuras. Isso permite que o Claude mantenha a continuidade do conhecimento sobre projetos mesmo após o término ou a reconexão das sessões.
</p>
...
Ou instale para o Antigravity CLI ([guia de configuração](https://docs.kimi-mem.ai/antigravity-cli/setup)):
...
> **Observação:** o Kimi-Mem também é publicado no npm, mas `npm install -g kimi-mem` instala **apenas o SDK/biblioteca** — ele não registra os hooks do plugin nem configura o serviço worker. Sempre instale via `npx kimi-mem install` ou pelos comandos `/plugin` acima.

### 🦞 OpenClaw Gateway

Instale o kimi-mem como um plugin de memória persistente em gateways [OpenClaw](https://openclaw.ai) com um único comando:
...
📚 **[Ver Documentação Completa](https://docs.kimi-mem.ai/)** - Navegue no site oficial

### Começando

- **[Guia de Instalação](https://docs.kimi-mem.ai/installation)** - Início rápido e instalação avançada
- **[Guia de Uso](https://docs.kimi-mem.ai/usage/getting-started)** - Como o Kimi-Mem funciona automaticamente
- **[Ferramentas de Busca](https://docs.kimi-mem.ai/usage/search-tools)** - Consulte o histórico do seu projeto com linguagem natural

### Melhores Práticas

- **[Engenharia de Contexto](https://docs.kimi-mem.ai/context-engineering)** - Princípios de otimização de contexto para agentes de IA
- **[Divulgação Progressiva](https://docs.kimi-mem.ai/progressive-disclosure)** - Filosofia por trás da estratégia de preparação de contexto do Kimi-Mem

### Arquitetura

- **[Visão Geral](https://docs.kimi-mem.ai/architecture/overview)** - Componentes do sistema e fluxo de dados
- **[Evolução da Arquitetura](https://docs.kimi-mem.ai/architecture-evolution)** - A jornada da v3 à v5
- **[Arquitetura de Hooks](https://docs.kimi-mem.ai/hooks-architecture)** - Como o Kimi-Mem usa hooks de ciclo de vida
- **[Referência de Hooks](https://docs.kimi-mem.ai/architecture/hooks)** - 7 scripts de hook explicados
- **[Serviço Worker](https://docs.kimi-mem.ai/architecture/worker-service)** - API HTTP e gerenciamento do Bun
- **[Banco de Dados](https://docs.kimi-mem.ai/architecture/database)** - Schema SQLite e busca FTS5
- **[Arquitetura de Busca](https://docs.kimi-mem.ai/architecture/search-architecture)** - Busca híbrida com banco de dados vetorial Chroma

### Configuração e Desenvolvimento

- **[Configuração](https://docs.kimi-mem.ai/configuration)** - Variáveis de ambiente e configurações
- **[Desenvolvimento](https://docs.kimi-mem.ai/development)** - Build, testes e contribuição
- **[Branches de Release](https://docs.kimi-mem.ai/branches)** - Fluxo das branches stable, core-dev e community-edge
- **[Solução de Problemas](https://docs.kimi-mem.ai/troubleshooting)** - Problemas comuns e soluções
...
Veja [Visão Geral da Arquitetura](https://docs.kimi-mem.ai/architecture/overview) para detalhes.

---

## Ferramentas de Busca MCP

O Kimi-Mem fornece busca inteligente de memória através de **4 ferramentas MCP** seguindo um padrão de fluxo de trabalho em **3 camadas**, eficiente em termos de tokens:
...
Veja o [Guia de Ferramentas de Busca](https://docs.kimi-mem.ai/usage/search-tools) para exemplos detalhados.
...
integrações da comunidade. Veja **[Branches de Release](https://docs.kimi-mem.ai/branches)**
...
As configurações são gerenciadas em `~/.kimi-mem/settings.json` (criado automaticamente com valores padrão na primeira execução). Configure o modelo de IA, a porta do worker, o diretório de dados, o nível de log e as configurações de injeção de contexto.

Veja o **[Guia de Configuração](https://docs.kimi-mem.ai/configuration)** para todas as configurações disponíveis e exemplos.

### Configuração de Modo e Idioma

O Kimi-Mem oferece suporte a múltiplos modos de fluxo de trabalho e idiomas através da configuração `KIMI_MEM_MODE`.
...
Edite seu arquivo de configurações em `~/.kimi-mem/settings.json`:
...
Veja o **[Guia de Desenvolvimento](https://docs.kimi-mem.ai/development)** para instruções de build, testes e fluxo de contribuição.
...
Veja o **[Guia de Solução de Problemas](https://docs.kimi-mem.ai/troubleshooting)** para problemas comuns e soluções.
...
O Kimi-Mem é distribuído a partir de três branches: `main` (estável), `core-dev` e
`community-edge`. Apenas a `main` é publicada no npm; as demais são executadas a partir do
código-fonte. Veja [Branches de Release](https://docs.kimi-mem.ai/branches) para a
estratégia e instruções de execução local.

Veja o [Guia de Desenvolvimento](https://docs.kimi-mem.ai/development) para o fluxo de contribuição.

---

## Licença

O Kimi-Mem é licenciado sob a Apache License 2.0.
...
- **Repositório**: [github.com/YD-233/kimi-mem](https://github.com/YD-233/kimi-mem)
...
CMEM é um token criado por terceiros, mas oficialmente adotado pelo criador do Kimi-Mem (Alex Newman, @thedotmack). O token funciona como um catalisador comunitário de crescimento e um veículo para levar o CMEM aos desenvolvedores e profissionais do conhecimento que mais precisam dele.
