...
Eller installer til Antigravity CLI ([opsætningsguide](https://docs.kimi-mem.ai/antigravity-cli/setup)):
...
> **Bemærk:** Kimi-Mem er også udgivet på npm, men `npm install -g kimi-mem` installerer kun **SDK'et/biblioteket** — det registrerer ikke plugin-hooks eller opsætter worker-servicen. Installer altid via `npx kimi-mem install` eller `/plugin`-kommandoerne ovenfor.

### 🦞 OpenClaw Gateway

Installer kimi-mem som et vedvarende hukommelsesplugin på [OpenClaw](https://openclaw.ai)-gateways med en enkelt kommando:

```bash
curl -fsSL https://install.cmem.ai/openclaw.sh | bash
```

Installationsprogrammet håndterer afhængigheder, plugin-opsætning, konfiguration af AI-udbyder, worker-opstart og valgfrie realtidsobservationsfeeds til Telegram, Discord, Slack og mere. Se [OpenClaw-integrationsguiden](https://docs.kimi-mem.ai/openclaw-integration) for detaljer.
...
📚 **[Se Fuld Dokumentation](https://docs.kimi-mem.ai/)** - Gennemse på den officielle hjemmeside

### Kom Godt I Gang

- **[Installationsguide](https://docs.kimi-mem.ai/installation)** - Hurtig start & avanceret installation
- **[Brugervejledning](https://docs.kimi-mem.ai/usage/getting-started)** - Sådan fungerer Kimi-Mem automatisk
- **[Søgeværktøjer](https://docs.kimi-mem.ai/usage/search-tools)** - Forespørg din projekthistorik med naturligt sprog

### Bedste Praksis

- **[Kontekst-engineering](https://docs.kimi-mem.ai/context-engineering)** - AI-agent kontekstoptimeringsprincipper
- **[Progressiv Afsløring](https://docs.kimi-mem.ai/progressive-disclosure)** - Filosofien bag Kimi-Mems kontekst-priming-strategi

### Arkitektur

- **[Oversigt](https://docs.kimi-mem.ai/architecture/overview)** - Systemkomponenter & dataflow
- **[Arkitekturudvikling](https://docs.kimi-mem.ai/architecture-evolution)** - Rejsen fra v3 til v5
- **[Hooks-arkitektur](https://docs.kimi-mem.ai/hooks-architecture)** - Hvordan Kimi-Mem bruger livscyklus-hooks
- **[Hooks-reference](https://docs.kimi-mem.ai/architecture/hooks)** - 7 hook-scripts forklaret
- **[Worker Service](https://docs.kimi-mem.ai/architecture/worker-service)** - HTTP API & Bun-administration
- **[Database](https://docs.kimi-mem.ai/architecture/database)** - SQLite-skema & FTS5-søgning
- **[Søgearkitektur](https://docs.kimi-mem.ai/architecture/search-architecture)** - Hybrid søgning med Chroma vektordatabase

### Konfiguration & Udvikling

- **[Konfiguration](https://docs.kimi-mem.ai/configuration)** - Miljøvariabler & indstillinger
- **[Udvikling](https://docs.kimi-mem.ai/development)** - Bygning, testning, bidrag
- **[Release-grene](https://docs.kimi-mem.ai/branches)** - Flowet for stable, core-dev og community-edge-grene
- **[Fejlfinding](https://docs.kimi-mem.ai/troubleshooting)** - Almindelige problemer & løsninger
...
Se [Arkitekturoversigt](https://docs.kimi-mem.ai/architecture/overview) for detaljer.

---

## MCP Søgeværktøjer

Kimi-Mem leverer intelligent hukommelsessøgning gennem **4 MCP-værktøjer**, der følger et token-effektivt **3-lags workflowmønster**:
...
Se [Søgeværktøjsguide](https://docs.kimi-mem.ai/usage/search-tools) for detaljerede eksempler.
...
community-integrationer. Se **[Release-grene](https://docs.kimi-mem.ai/branches)**
...
Indstillinger administreres i `~/.kimi-mem/settings.json` (auto-oprettet med standardindstillinger ved første kørsel). Konfigurer AI-model, worker-port, datakatalog, log-niveau og indstillinger for kontekstindsprøjtning.

Se **[Konfigurationsguide](https://docs.kimi-mem.ai/configuration)** for alle tilgængelige indstillinger og eksempler.

### Tilstands- & Sprogkonfiguration

Kimi-Mem understøtter flere workflow-tilstande og sprog via indstillingen `KIMI_MEM_MODE`.
...
Rediger din indstillingsfil på `~/.kimi-mem/settings.json`:
...
Se **[Udviklingsguide](https://docs.kimi-mem.ai/development)** for bygningsinstruktioner, testning og bidragsworkflow.
...
Se **[Fejlfindingsguide](https://docs.kimi-mem.ai/troubleshooting)** for almindelige problemer og løsninger.
...
Kimi-Mem udsendes fra tre grene: `main` (stable), `core-dev` og
`community-edge`. Kun `main` publiceres til npm; de andre køres fra
kildekode. Se [Release-grene](https://docs.kimi-mem.ai/branches) for
strategien og instruktioner til lokal kørsel.

Se [Udviklingsguide](https://docs.kimi-mem.ai/development) for bidragsworkflow.

---

## Licens

Kimi-Mem er licenseret under Apache License 2.0.
...
- **Officiel Discord**: [Deltag i Discord](https://discord.com/invite/J4wttp9vDu)
...
CMEM er en token skabt af en tredjepart, men officielt anerkendt af skaberen af Kimi-Mem (Alex Newman, @thedotmack). Tokenet fungerer som en katalysator for fællesskabsvækst og et redskab til at bringe CMEM til de udviklere og videnarbejdere, der har mest brug for det.
