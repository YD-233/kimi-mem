# kimi-mem Architecture Overview
...
+-----------------------------------------------------------+
|  Storage Layer                                            |
|  +-- SQLite (kimi-mem.db) -- structured data            |
...
|-------|---------|-------------|---------|
| Setup | version-check.js | Sub-100ms version-marker check; prompts `npx kimi-mem repair` on mismatch | 60s |
