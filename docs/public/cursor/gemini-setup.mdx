...
description: "Use Kimi-Mem in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up Kimi-Mem in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.

<Info>
**Free Tier:** generous daily quota with `gemini-flash-latest`. No credit card required.
</Info>
...
{
  "KIMI_MEM_PROVIDER": "gemini",
  "KIMI_MEM_GEMINI_API_KEY": "your-key",
  "KIMI_MEM_GEMINI_MODEL": "gemini-3.5-flash"
}
```

## Rate Limiting

Kimi-Mem automatically handles rate limiting for free tier usage:
