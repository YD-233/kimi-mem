...
description: "Learn how Kimi-Mem works automatically in the background"
---

# Getting Started with Kimi-Mem

## Automatic Operation

Kimi-Mem works automatically once installed. No manual intervention required!
...
Every time Claude uses a tool, kimi-mem captures it:
...
Context is stored in SQLite database at `~/.kimi-mem/kimi-mem.db`.
...
Kimi-Mem supports sessions that span multiple user prompts:
...
Kimi-Mem provides MCP tools for querying your project history. Simply ask naturally:
