---
title: "Development"
description: "Build from source, run tests, and contribute to Kimi-Mem"
---
...
Kimi-Mem relies on **real-world usage and manual testing** rather than traditional unit tests. The project philosophy prioritizes:
...
3. **Check database state**:
   ```bash
   sqlite3 ~/.kimi-mem/kimi-mem.db "SELECT * FROM your_table;"
   ```
...
```bash
npm publish
npm view kimi-mem@NEW_VERSION version
```
