...
engine, Kimi-Mem Server, CLI, SDKs, adapters, MCP tools, schemas, tests,
...
Kimi-Mem is intended to be embedded broadly inside developer tools, local
...
Kimi-Mem Server v0.1 does not ship hosted cloud, team sync, enterprise
